package com.example.filenamesql.sql
...
class Db_Helper @SuppressLint("SdCardPath") constructor(context: Context?) :
    SQLiteOpenHelper(context, "Mydatabase.db", null, 1) {
    var context: Context?
    var DB_NAME = "Mydatabase.db"
...
//        Log.e("TAG", "readdata: "+cursor.count )
